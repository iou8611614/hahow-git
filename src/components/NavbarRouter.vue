  ...
  <b-navbar toggleable="sm" type="dark" variant="info" class="nav-route">
    ...
    <b-collapse id="nav-collapse" is-nav>
      <b-navbar-nav class="ml-auto">
        <b-nav-item
          v-show="
            this.$route.path !== '/Blog/Welcome' &&
              this.$route.path !== '/Blog/Logout'
          "
        >
          <router-link
            class="route-style"
        ...
        <b-nav-item
          v-show="
            this.$route.path !== '/Blog/Login' &&
              this.$route.path !== '/Blog/Profile/Jason' &&
              this.$route.path !== '/Blog/Edit/Jason' &&
              this.$route.path !== '/Blog/Logout'
          "
        >
          <router-link
